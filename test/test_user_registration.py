class TestUserRegistration:
    def test_user_registration(self, post_registration):
        response = post_registration.user_registration(email="soloveva5@test.ru", password="Banan3",
                                                       username="Svetlana5")
    ...
    def test_user_already_registered(self, post_registration):
        response = post_registration.user_registration(email="soloveva3@test.ru", password="Banan3",
                                                       username="Svetlana3")
        json_response = response.json()
